...
/**
 * The quick_edit_anonymous_instantiated event.
 *
...
/**
 * The quick_edit_anonymous_instantiated event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class quick_edit_anonymous_instantiated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquick_edit_anonymous_instantiated', 'grade_report_quick_edit');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} instantiated a set of " . 
    ...
    public static function get_legacy_quick_edit_anonymous_instantiated() {
        return 'quick_edit_anonymous_instantiated';
    }
