...
/**
 * The quick_edit_other_table_built event.
 *
...
/**
 * The quick_edit_other_table_built event class.  This event is used when
 * something other than a quick_edit_anonymous or quick_edit_grade object is
 * used to build a table.  Prior implementations simply threw these events to
 * the wind with no handler.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class quick_edit_other_table_built extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquick_edit_other_table_built', 'grade_report_quick_edit');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} built a table of " . 
            "something other than grade items for a course with id " . 
            "{$this->courseid}.";
    }
    ...
    public static function get_legacy_quick_edit_other_table_built() {
        return 'quick_edit_other_table_built';
    }
