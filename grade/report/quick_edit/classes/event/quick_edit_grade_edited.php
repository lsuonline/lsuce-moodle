...
/**
 * The quick_edit_grade_edited event.
 *
...
/**
 * The quick_edit_grade_edited event class.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 **/
class quick_edit_grade_edited extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquick_edit_grade_edited', 'grade_report_quick_edit');
    }
 
    public function get_description() {
        return "The user with id {$this->userid} edited a set of grade items " . 
            "for a course with id {$this->courseid}.";
    }
    ...
    public static function get_legacy_quick_edit_grade_edited() {
        return 'quick_edit_grade_edited';
    }
