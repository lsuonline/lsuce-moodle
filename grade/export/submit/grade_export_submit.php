...
class grade_export_submit extends grade_export
{

    public $plugin = 'submit';
    ...
    {
        $formdata = new stdObject();
        $formdata->itemids = $itemlist;
        $formdata->export_feedback = $export_feedback;
        $formdata->updatedgradesonly = $updatedgradesonly;
        $formdata->displaytype = $displaytype;
        $formdata->decimals = $decimalpoints;
        $formdata->onlyactive = $onlyactive;
        $formdata->usercustomfields = $usercustomfields;

        parent::__construct($course, $groupid, $formdata); // , $export_feedback, $updatedgradesonly, $displaytype, $decimalpoints);
        $this->separator = $separator;
    }

    public function grade_export_submit($course, $groupid = 0, $itemlist = '', $export_feedback = false, $updatedgradesonly = false, $displaytype = GRADE_DISPLAY_TYPE_REAL, $decimalpoints = 2, $separator = 'comma')
    {
    ...
    // ************This is what creates the file to export.*******
