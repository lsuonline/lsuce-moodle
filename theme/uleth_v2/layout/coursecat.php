...
// ===================    UofL Start    ===================
// error_log("\n\n Do we have custom_header_links: ". print_r($PAGE->theme->settings->custom_header_links, 1). "\n");
// error_log("\n\n da fuck is the settings: ". print_r($PAGE->theme->settings, 1). "\n");
$custom_top_links = explode(",", $PAGE->theme->settings->custom_header_links);
$custom_top_links_count = count($custom_top_links);
// error_log("\n\n what is the link count: ". $custom_top_links_count);
...
// ===================    UofL End      ===================
// error_log("\n\nDa fuck is tc links: ". print_r($teachingcentre_links, 1). "\n");
...
echo "<script>console.log('<<----------- COURSECAT ---------->>');</script>";

// ===================    UofL Start    ===================
// echo $OUTPUT->render_from_template('theme_boost/columns2', $templatecontext);
echo $OUTPUT->render_from_template('theme_uleth_v2/coursecat', $templatecontext);
// ===================    UofL End      ===================
