...
$regionmainbox = 'col-12';
// $regionmain = 'col-12 col-md-8 col-lg-9';
$regionmain = 'col-12';
// $sidepre = 'col-12 col-md-4 col-lg-3';

// $sidepre2 = 'desktop-first-column';
// $sidepost = 'col-3 pull-right';
...
// if (empty($custom_top_links)) {
//     error_log("\nXXXXX----->>>> IS EMPTY <<<<<------XXXXXXX");
// } else {
//     error_log("\nZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ");
// }

if ($custom_top_links_count != 1 && $custom_top_links[0] != "") {
    error_log("\n");
    error_log("\nthere are no links to display for this page");
...
echo $OUTPUT->render_from_template('theme_uleth_v2/local', $templatecontext);
