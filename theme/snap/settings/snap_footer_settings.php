...
$title = new \core\lang_string('snapfootercustomization', 'theme_snap');
$description = new \core\lang_string('snapfootercustomizationdesc', 'theme_snap');
$setting = new admin_setting_heading($name, $title, $description);
$snapsettings->add($setting);

// Custom footer setting.
$name = 'theme_snap/footnote';
$title = new \core\lang_string('footnote', 'theme_snap');
$description = new \core\lang_string('footnotedesc', 'theme_snap');
$default = '';
$setting = new admin_setting_confightmleditor($name, $title, $description, $default);
$snapsettings->add($setting);

$name = 'theme_snap/footercolorsheading';
$title = new \core\lang_string('snapfootercolors', 'theme_snap');
$description = new \core\lang_string('snapfootercolorsdesc', 'theme_snap');
$setting = new admin_setting_heading($name, $title, $description);
$snapsettings->add($setting);

// Custom footer background color setting.
$name = 'theme_snap/footerbg';
$title = new \core\lang_string('snapfooterbgcolor', 'theme_snap');
$description = '';
$default = '#474747';
...
$title = new \core\lang_string('snapfootertxtcolor', 'theme_snap');
$description = '';
$default = '#ffffff';
