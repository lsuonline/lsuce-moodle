...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function personal_menu() {
        ...
        // Check to see if cas_help_links installed so that we do not create an error when creating the links below.
        $test = class_exists('local_cas_help_links_url_generator');
        ...
        if($test){
            $helpurlarray = \local_cas_help_links_url_generator::getUrlForUser($USER->id);
            $cashelplink = [
                'prefix' => $helpurlarray['display'] ? ' - '                  : '',
                'link'   => $helpurlarray['display'] ? $helpurlarray['url']   : '',
                'target' => $helpurlarray['display'] ? '_blank'               : '',
                'title'  => $helpurlarray['display'] ? $helpurlarray['label'] : ''
            ];
        }
