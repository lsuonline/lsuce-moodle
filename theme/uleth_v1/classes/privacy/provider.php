...
/**
 * Privacy Subsystem implementation for theme_uleth_v1.
 *
...
namespace theme_uleth_v1\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_uleth_v1');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_uleth_v1');
            }
