!function(e) {
    ...
    var t, n, i, o, a, r, s = "Close", l = "BeforeClose", c = "AfterClose", d = "BeforeAppend", u = "MarkupParse", p = "Open", f = "Change", m = "mfp", g = "." + m, h = "mfp-ready", v = "mfp-removing", C = "mfp-prevent-close", y = function() {}, w = !!window.jQuery, b = e(window), I = function(e, n) {
        t.ev.on(m + e + g, n);
    }, x = function(t, n, i, o) {
        var a = document.createElement("div");
        return a.className = "mfp-" + t, i && (a.innerHTML = i), o ? n && n.appendChild(a) : (a = e(a), 
        n && a.appendTo(n)), a;
    }, k = function(n, i) {
        t.ev.triggerHandler(m + n, i), t.st.callbacks && (n = n.charAt(0).toLowerCase() + n.slice(1), 
        t.st.callbacks[n] && t.st.callbacks[n].apply(t, e.isArray(i) ? i : [ i ]));
    }, T = function(n) {
        return n === r && t.currTemplate.closeBtn || (t.currTemplate.closeBtn = e(t.st.closeMarkup.replace("%title%", t.st.tClose)), 
        r = n), t.currTemplate.closeBtn;
    }, E = function() {
    ...
    y.prototype = {
        ...
        init: function() {
            ...
            t.isAndroid = /android/gi.test(n), t.isIOS = /iphone|ipad|ipod/gi.test(n), t.supportsTransition = _(), 
        ...
        open: function(n) {
            ...
            t.types = [], a = "", n.mainEl && n.mainEl.length ? t.ev = n.mainEl.eq(0) : t.ev = i, 
            ...
            t.st.enableEscapeKey = !1), t.bgOverlay || (t.bgOverlay = x("bg").on("click" + g, function() {
                t.close();
            ...
            }), a += " mfp-close-btn-in") : t.wrap.append(T())), t.st.alignTop && (a += " mfp-align-top"), 
            ...
            k("BuildControls"), e("html").css(f), t.bgOverlay.add(t.wrap).prependTo(t.st.prependTo || e(document.body)), 
        ...
        close: function() {
            t.isOpen && (k(l), t.isOpen = !1, t.st.removalDelay && !t.isLowIE && t.supportsTransition ? (t._addClassToMFP(v), 
            setTimeout(function() {
                t._close();
        ...
        _close: function() {
            ...
            i.off("keyup" + g + " focusin" + g), t.ev.off(g), t.wrap.attr("class", "mfp-wrap").removeAttr("style"), 
            ...
            t.content = null, t.currTemplate = null, t.prevHeight = 0, k(c);
        },
        ...
        updateItemHTML: function() {
            ...
            var i = n.type;
            if (k("BeforeChange", [ t.currItem ? t.currItem.type : "", i ]), t.currItem = n, 
            !t.currTemplate[i]) {
                var a = t.st[i] ? t.st[i].markup : !1;
                k("FirstMarkupParse", a), a ? t.currTemplate[i] = e(a) : t.currTemplate[i] = !0;
            }
            o && o !== n.type && t.container.removeClass("mfp-" + o + "-holder");
            var r = t["get" + i.charAt(0).toUpperCase() + i.slice(1)](n, t.currTemplate[i]);
            t.appendContent(r, i), n.preloaded = !0, k(f, n), o = n.type, t.container.prepend(t.contentContainer), 
            k("AfterChange");
        },
        appendContent: function(e, n) {
            t.content = e, e ? t.st.showCloseBtn && t.st.closeBtnInside && t.currTemplate[n] === !0 ? t.content.find(".mfp-close").length || t.content.append(T()) : t.content = e : t.content = "", 
        ...
        if ("string" == typeof n) if ("open" === n) {
            var o, a = w ? i.data("magnificPopup") : i[0].magnificPopup, r = parseInt(arguments[1], 10) || 0;
        ...
        w ? i.data("magnificPopup", n) : i[0].magnificPopup = n, t.addGroup(i, n);
        return i;
    };
            ...
            getInline: function(n, i) {
                if (M(), n.src) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (P || (S = o.hiddenClass, P = x(S), S = "mfp-" + S), O = a.after(P).detach().removeClass(S)), 
            ...
            getAjax: function(n) {
                ...
                var i = e.extend({
                    ...
                    success: function(i, o, a) {
                        ...
                        k("ParseAjax", r), t.appendContent(e(r.data), F), n.finished = !0, L(), t._setFocus(), 
                        setTimeout(function() {
                            t.wrap.addClass(h);
    ...
    e.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(e) {
                e.img && (e.hasSize = !0, A && clearInterval(A), e.isCheckingImgSize = !1, k("ImageHasSize", e), 
            ...
            getImage: function(n, i) {
                var o = 0, a = function() {
                    ...
                    t.updateStatus("ready")), n.hasSize = !0, n.loaded = !0, k("ImageLoadComplete")) : (o++, 
                ...
                if (l.length) {
                    ...
                    n.img = e(c).on("load.mfploader", a).on("error.mfploader", r), c.src = n.src, l.is("img") && (n.img = n.img.clone()), 
                    c = n.img[0], c.naturalWidth > 0 ? n.hasSize = !0 : c.width || (n.hasSize = !1);
                }
                return t._parseMarkup(i, {
                    title: j(n),
                    img_replaceWith: n.img
                }, n), t.resizeImage(), n.hasSize ? (A && clearInterval(A), n.loadError ? (i.addClass("mfp-loading"), 
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                var s = {
                    width: i.width(),
                    height: (w ? i.innerHeight() : i[0].offsetHeight) - r - a
                };
    ...
    var R = "iframe", Z = "//about:blank", K = function(e) {
        if (t.currTemplate[R]) {
    ...
    e.magnificPopup.registerModule(R, {
        ...
        proto: {
            ...
            getIframe: function(n, i) {
                ...
                var r = {};
                return a.srcAction && (r[a.srcAction] = o), t._parseMarkup(i, r, n), t.updateStatus("ready"), 
                i;
            }
        }
    });
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                var n = t.st.gallery, o = ".mfp-gallery", r = Boolean(e.fn.mfpFastClick);
                return t.direction = !0, n && n.enabled ? (a += " mfp-gallery", I(p + o, function() {
                    ...
                    o.counter = r > 1 ? D(n.tCounter, a.index, r) : "";
                }), I("BuildControls" + o, function() {
                    if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                        var i = n.arrowMarkup, o = t.arrowLeft = e(i.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(C), a = t.arrowRight = e(i.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(C), s = r ? "mfpFastClick" : "click";
                        o[s](function() {
                            t.prev();
                        }), a[s](function() {
                            t.next();
                        }), t.isIE7 && (x("b", o[0], !1, !0), x("a", o[0], !1, !0), x("b", a[0], !1, !0), 
                        x("a", a[0], !1, !0)), t.container.append(o.add(a));
                    }
                }), I(f + o, function() {
                    ...
                    i.off(o), t.wrap.off("click" + o), t.arrowLeft && r && t.arrowLeft.add(t.arrowRight).destroyMfpFastClick(), 
    ...
    e.magnificPopup.registerModule(Y, {
        ...
        e.fn.mfpFastClick = function(o) {
            return e(this).each(function() {
                ...
                if (n) {
                    ...
                    s.on("touchstart" + a, function(e) {
                        ...
                        c = p.clientX, d = p.clientY, b.on("touchmove" + a, function(e) {
            ...
            e(this).off("touchstart" + a + " click" + a), n && b.off("touchmove" + a + " touchend" + a);
        };
    }(), E();
});