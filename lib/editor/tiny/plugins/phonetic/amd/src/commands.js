...
// Inline SVG for the toolbar icon — a centred "ʃ" (the most recognisable IPA
// symbol). Using an inline SVG rather than getButtonImage() ensures the icon
// fills the TinyMCE button area the same way as other toolbar icons.
const iconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  <text x="12" y="17" text-anchor="middle" font-size="18"
        font-family="Georgia, serif" fill="currentColor">ʃ</text>
</svg>`;
