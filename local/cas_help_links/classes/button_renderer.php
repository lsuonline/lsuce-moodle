...
class local_cas_help_links_button_renderer {
    ...
    public static function get_html_for_course($course, $attributes = []) {
        ...
        return $help_url_array['display'] ? '<a class="'
                                            . $class
                                            . '" href="'
                                            . $interstitial_url
                                            . '" target="_blank" title="'
     ...
     * @return string
     */
    public static function get_html_for_snap($course) {
        $help_url_array = \local_cas_help_links_url_generator::getUrlArrayForCourse($course);
        ...
        return $help_url_array['display'] ? '<a href="' . $interstitial_url . '" target="_blank" title="' . $tooltip_text . '">' . $help_url_array['label'] . '</a>' : '';
    }
     ...
     * @return string
     */
    public static function get_html_for_snapuser($user_id) {
        $help_url_array = \local_cas_help_links_url_generator::getUrlForUser($user_id);

        if ( ! $help_url_array['display'])
            return '';

            return $help_url_array['display'] ? ' - <a href="' . $help_url_array['url'] . '" target="_blank">' . $help_url_array['label'] . '</a>' : '';
        }
