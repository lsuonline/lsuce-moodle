...
echo $output->single_select('category_analytics.php'
                            , 'dept'
                            , \local_cas_help_links_utility::get_category_data(true)
                            , $selected_dept
                            , ['' => 'All departments']
                            , 'dept-select'
                            , []);
...
$PAGE->requires->js_call_amd('local_cas_help_links/semesterUsageChart'
                            , 'initialise'
                            , array($weeks, $userTotals, $clickTotals, ));
