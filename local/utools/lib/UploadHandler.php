...
class UploadHandler
{
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null)
    {
        ...
        // error_log("UploadHandler -> __construct() -> START");
        $this->response = array();
        ...
        // error_log("UploadHandler -> __construct() -> what are the options: ".print_r($this->options, 1));
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null)
    {
        ...
        // Saving file.
        $dir = make_temp_directory('utools_temp_upload/');

        if (empty($file->name)) {
            $filename = uniqid('utools_temp_upload', true).'_'.time().'.tmp';
        } else {
            $filename = $file->name;
        }
        ...
        move_uploaded_file($uploaded_file, $savedfilepath);
        ...
        $fs->create_file_from_pathname($file_record, $savedfilepath);
    ...
    public function generate_response($content, $print_response = true)
    {
        ...
        if ($print_response) {
            ...
            if ($redirect) {
                ...
                // error_log("generate_response() -> redirect, returning");
                return;
            }
            $this->head();
        ...
        // error_log("generate_response() -> returning this ". print_r($content, 1));
        return $content;
    }
    ...
    public function post($print_response = true)
    {
        ...
        if ($upload) {
            if (is_array($upload['tmp_name'])) {
                ...
                foreach ($upload['tmp_name'] as $index => $value) {
                    // error_log("upload file fudge monkey 1");
                ...
                // error_log("upload file fudge monkey 2");
                $files[] = $this->handle_file_upload(
        ...
        // error_log("upload file fudge monkey what is response: ". print_r($response, 1));
