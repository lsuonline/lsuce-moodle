...
class question_expected_grade extends question {

    public $type_name = "Expected Grade"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            get_string('expected_grade_A', 'local_evaluations'),
            get_string('expected_grade_B', 'local_evaluations'),
            get_string('expected_grade_C', 'local_evaluations'),
            get_string('expected_grade_D', 'local_evaluations'),
        );
