...
class question_gpa extends question {

    public $type_name = "My Overall GPA"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            get_string('gpa4', 'local_evaluations'),
            get_string('gpa3', 'local_evaluations'),
            get_string('gpa2', 'local_evaluations'),
            get_string('gpa1', 'local_evaluations'),
        );
