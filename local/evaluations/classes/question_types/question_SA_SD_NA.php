...
class question_SA_SD_NA extends question {

    public $type_name = "Agree - Neutral - Disagree - NA"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            ...
            get_string('NA', 'local_evaluations'),
        );
