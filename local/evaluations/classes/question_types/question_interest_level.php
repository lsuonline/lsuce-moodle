...
class question_interest_level extends question {

    public $type_name = "Level of Interest"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            get_string('interest_level_mmp', 'local_evaluations'),
            get_string('interest_level_mp', 'local_evaluations'),
            get_string('interest_level_s', 'local_evaluations'),
            get_string('interest_level_mn', 'local_evaluations'),
            get_string('interest_level_mmn', 'local_evaluations'),
        );
