...
class question_course_pace extends question {

    public $type_name = "Course Pace"; //loaded to database on install / update
    ...
    function display(&$mform, $form, $data, $order) {
        ...
        $abr = array(
            get_string('course_pace_TS', 'local_evaluations'),
            get_string('course_pace_S', 'local_evaluations'),
            get_string('course_pace_JR', 'local_evaluations'),
            get_string('course_pace_F', 'local_evaluations'),
            get_string('course_pace_TF', 'local_evaluations'),
        );
