...
class evaluation {
    ...
    function load_creation_form(&$mform, $form, $data, $include_questions = true) {
        ...
        if ($include_questions) { // If we are going to include questions - prepare forum and load their data
            ...
            $mform->addElement('html', '<b><span style="color:red; position:relative; left:115px;">Warning: Save your questions before adding fields!</span></b>');
        ...
        $buttonarray = array();
        $buttonarray[] = &$mform->createElement('submit', 'submitbutton',get_string('saveq', 'local_evaluations'));
