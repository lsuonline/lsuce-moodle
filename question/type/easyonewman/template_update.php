...
// UofL Fix ------------------
// error_log("\n\nNEWMAN -> template_update");
$easyonewmanbuildstring = str_replace("question/type/easyonewman/pix", $CFG->wwwroot. "/question/type/easyonewman/pix", $easyonewmanbuildstring);
