    ...
    insert_easyomechjs_applet: function(Y, toreplaceid, appletid, name,
        ...
        if (!this.show_java(toreplaceid, appletid, name, 600, 900,
            ...
            var MarvinControllerClass = (function() {
                ...
                if (inputform != null) {
                var nextbutton = inputform.all('input[type=submit]');
...
/*
    ...
    show_java: function(id, appletid, name, width, height, appletclass,
        ...
        newIframe.src = moodleurl + marvinpath + "/editor.html";
        ...
        node.on("click", function() {
            ...
            MarvinJSUtil.getEditor("#MSketch").then(
                function(sketcherInstance) {
                    marvinController = new MarvinControllerClass(
                        sketcherInstance);
                    //var buttonid = node.getAttribute('id'); //Disha Fix : get Insert from editor button id
        ...
        node.on("click", function() {
            ...
            MarvinJSUtil.getEditor("#MSketch").then(
                function(sketcherInstance) {
                    marvinController = new MarvinControllerClass(
                        sketcherInstance);
                     //var buttonid = node.getAttribute('id'); //Disha Fix : get view in editor button id
                    var buttonid = node.one('button').getAttribute("id");
