...
$easyofischerbuildstring = file_get_contents('edit_fischer'.$numofstereo.'.html').file_get_contents('fischer_dragable.html');
$easyofischerbuildstring .= html_writer::end_tag('div');  // End divnew!
/////may delete this part
// UofL Fix ------------------
// error_log("\n\nFISCHER -> template_update");
