...
class qtype_easyofischer_renderer extends qtype_renderer {
    public function formulation_and_controls(question_attempt $qa, question_display_options $options) {
        ...
        if ($options->readonly) {
            ...
            $result .= html_writer::tag('textarea', $answer['answer'], array(
                ...
                $this->page->requires->js_init_call('M.qtype_easyofischer.insert_easyofischer_answer_pagenavigation', array($qa->get_slot(),$moodleroot,$numofstereo, $qa->get_usage_id()));
        }
        ...
        if ($options->readonly) {
            ...
            $temp = str_replace("question/type/easyofischer/pix", $CFG->wwwroot. "/question/type/easyofischer/pix", $temp);
    ...
    protected function require_js(question_attempt $qa, $readonly, $correctness, $numofstereo) {
        ...
        $topnode  = 'div.que.easyofischer#question-' . $qa->get_usage_id() . '-' . $qa->get_slot();
        if ($correctness) {
