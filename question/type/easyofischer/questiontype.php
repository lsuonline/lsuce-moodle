...
class qtype_easyofischer extends qtype_shortanswer {
    ...
    public function save_question_options($question) {
        ...
        $oldoptions = array_values($DB->get_records('question_easyofischer',
        ...
        $options->numofstereo = $question->numofstereo;
        $options->strictfischer = $question->strictfischer;

        $DB->update_record('question_easyofischer', $options);
    }
}
