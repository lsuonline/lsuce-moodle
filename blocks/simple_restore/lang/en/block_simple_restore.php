...
$string['restore_confirm_body_overwrite'] = 'This will replace the course content (activities, resources, and sections) with content from the selected backup. Student enrolments and grades will not be affected. This action cannot be undone.';
$string['restore_confirm_body_import'] = 'This will add activities, resources, and sections from the selected backup into this course without removing existing content. Student enrolments and grades will not be affected.';
