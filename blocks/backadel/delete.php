...
admin_externalpage_setup('block_backadel_delete');
$context = context_system::instance();
require_capability('block/backadel:deletearchive', $context);
...
$completedids = $DB->get_fieldset_select(
...
echo html_writer::div(
    html_writer::tag('button', '?', [
        ...
        'data-help-topic' => 'delete',
        'data-help-title' => get_string('delete_header', 'block_backadel'),
...
if (!$completedids) {
    echo html_writer::div(get_string('none_completed', 'block_backadel'));
    echo $OUTPUT->footer();
    exit;
}

$table = new \block_backadel\local\table\delete_table('backadel-delete');
$table->out(30, true);
