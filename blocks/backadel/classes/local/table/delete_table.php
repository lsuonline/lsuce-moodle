...
/**
 * Lists completed Backadel backups eligible for deletion — replaces the {@see \html_table} in delete.php.
 *
...
class delete_table extends base_backadel_table {
    ...
    protected function setup_sql(): void {
        ...
        $fields = 'co.id, co.shortname, co.fullname, cat.name AS category, ba.status AS status, '
        ...
        $where = 'ba.status = :success_status';
    ...
    public function col_actions(stdClass $row): string {
        ...
        return html_writer::tag('a', get_string('results_action_delete', 'block_backadel'), [
            'href' => '#',
