...
define(['jquery', 'core/ajax', 'block_course_hider/notifications'],
    function($, Ajax, Noti) {
    'use strict';
    ...
    return {
         ...
         */
        CHAjax: function(data_chunk) {
            var promiseObj = new Promise(function(resolve, reject) {
                var send_this = [{
                    methodname: 'block_course_hider_chajax',
                    args: {
                ...
                Ajax.call(send_this)[0].then(function(response) {
                    ...
                    console.log("CHAjax() -> JAXY Fail :-(");
                    console.log("CHAjax() -> JAXY Fail going to reject: ", ev);
                    reject(ev);
                });
            });
            return promiseObj;
         ...
         * @return {promise} Resolved with an array of the calendar events
         */
        CHRemoteAjax: function(data_chunk) {
