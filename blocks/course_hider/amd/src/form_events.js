 ...
 */
 ...
 define(['jquery', 'block_course_hider/ch_lib', 'block_course_hider/notifications'],
    function($, CHLib, Noti) {
    'use strict';
    return {
        /**
        ...
        getTokenReady: function () {
            ...
            CHLib.getTokenForURL(url).then(function (response) {
        ...
        verifyDestCourse: function (params) {
            ...
            return CHLib.jaxyRemotePromise(new_params);
        },
        ...
        registerMoodleEvents: function() {
            ...
            $('#id_verifysource').on('click', function() {
                ...
                var params = {
                    ...
                    'data': {
                        'wstoken': test_token,
                        'wsfunction': 'block_course_hider_chajax',
                        'moodlewsrestformat': 'json',
                        // 'data': {
                ...
                CHLib.testWebServices(params).then(function (response) {
        ...
        registerMappingEvents: function() {
            ...
            $('#id_verifysource').on('click', function() {
                ...
                if (sessionStorage.getItem("sample_autocomplete") == "1") {
        ...
        registerEvents: function () {
            ...
            if (sessionStorage.getItem('course_hider_form') == "course_hider" && sessionStorage.getItem('course_hiderform') == "true") {
