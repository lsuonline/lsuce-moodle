...
define(['jquery', 'core/ajax', 'block_course_hider/notifications', 'block_course_hider/ch_lib'],
    function($, Ajax, Noti, CHLib) {
    'use strict';
    return {
        /**
         ...
         */
         getGroups: function (c, v) {
            ...
            return CHLib.jaxyRemotePromise(params);
        },
         ...
         getCourses: function (params) {
            var params = {
                ...
                'data': {
                    ...
                    "criterianame": 'search',
                    'criteriavalue': $('.ch_dest_sn_wrap input').val(),
                    'moodlewsrestformat': 'json'
                }
            };
            return CHLib.jaxyRemotePromise(params);
