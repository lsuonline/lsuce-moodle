...
class block_course_hider_external extends external_api {

    /**
     * Returns description of method parameters.
     * @return external_function_parameters
     */
    public static function chajax_parameters() {
     ...
     */
    public static function chajax($datachunk) {
        ...
        if (isset($classobj)) {
            ...
            $chclass = new $classobj();
        } else {
            // TODO: If we want custom logging for this plugin then replace.
            debugging("\nchajax => Rejected, no file specified!!!");
            die (json_encode(array("success" => "false")));
        }

        // Now let's call the method.
        $leftoverdata = null;
        if (method_exists($chclass, $function)) {
            $leftoverdata = call_user_func(array($chclass, $function), $params);
        } else {
            // TODO: If we want custom logging for this plugin then replace.
            debugging("\nchajax.php => Rejected, method does not exist!!!");
            die (json_encode(array("success" => "false")));
        }
     ...
     */
    public static function chajax_returns() {
