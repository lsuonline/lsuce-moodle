...
class message_draft_attachment extends \block_quickmail\persistents\persistent {
    ...
    public static function clear_all_for_message(message $message) {
        ...
        $records = $DB->get_records('block_quickmail_msg_attach', ['message_id' => $message->get('id')]);

        $fs = get_file_storage();
        $thismessageid = $message->get('id');
