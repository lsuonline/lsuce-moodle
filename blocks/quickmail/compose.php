...
try {
    ...
    if ($request->is_form_cancellation()) {
        ...
        // LSU Quickmail Enhancement
        // TK_NOTE: These notes are just here until we have a repo that can record these changes.
        // TK_NOTE: was: redirect back to course page
        // TK_NOTE: was: $request->redirect_to_url('/course/view.php', ['id' => $course->id]);
        // redirect back to Quickmail menu
        $request->redirect_to_url('/blocks/quickmail/qm.php', ['courseid' => $course->id]);
        // End LSU Quickmail Enhancement
