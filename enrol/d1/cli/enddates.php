...
$token   = 'C35F196B40128B7055199C61452F309F';
...
foreach ($d1ids as $d1id) {
    ...
    mtrace("  Finished processing $d1id->email.");
}
...
class ihated1 {
  ...
  public static function update_scotty_d1($d1id, $enrollid) {
    ...
    public static function get_d1ids() {
        global $CFG, $DB;
        $sql = 'SELECT id, x_number, d1_id, logonid, email, customsectionnumber, duedate
            FROM mdl_scotty_enr
            WHERE updated = 1
    ...
    public static function set_ddcache($token, $enrollid) {
        ...
        $url = 'https://lsuonlinetestsv.destinyone.moderncampus.net/srs/enrolmgr/common/course/studentEnrolledCourses.do'
    ...
    public static function set_duedate($token, $enrollid, $day, $month, $year, $reason) {
        require_once 'HTTP/Request2.php';
        $url = 'https://lsuonlinetestsv.destinyone.moderncampus.net/srs/enrolmgr/common/course/assignmentDueDate.do'
    ...
    public static function set_enrollcache($token, $d1id) {
        require_once 'HTTP/Request2.php';
        $url = 'https://lsuonlinetestsv.destinyone.moderncampus.net/srs/enrolmgr/student/profile/studentRapidProfile.do?method=edit&businessObjectId='
            . $d1id
    ...
    public static function get_enrollids($token, $d1id) {
        require_once 'HTTP/Request2.php';
        $request = new HTTP_Request2();
        $request->setUrl('https://lsuonlinetestsv.destinyone.moderncampus.net/srs/enrolmgr/common/course/studentEnrolledCourses.do?method=load&businessObjectId=' . $d1id . '&refresh=true');
