...
// title
$string['uofl_title'] = 'University of Lethbridge Settings';
// left column
$string['uofl_default_blocks_left'] = 'Add additional blocks to left side(blank for default)';
$string['uofl_default_blocks_right'] = 'Add additional blocks to right side(blank for default)';
$string['uofl_course_year'] = 'Course Import Year';
$string['uofl_course_term'] = 'Semester Term';

$string['dead_enrollments'] = 'Dead Enrollments';
$string['local_lmb_debugging_title'] = 'Enable extra debugging settings';
$string['local_lmb_debugging_xml_title'] = 'Enable extra debugging for xml imports';
$string['local_lmb_user_force_merge_title'] = 'Merge Banner data from users who accessed Moodle early';
$string['local_lmb_debugging_xml_custom_title'] = 'Print out XML for specific users';
$string['local_lmb_debugging_xml_custom_sourcedid_title'] = 'Print out XML for specific users';


// right column help
$string['uofl_left_side_blocks_help'] = 'By default the navigation and Settings block will appear. Add additional blocks exactly like this: block_name_one,block_name_two ';
$string['uofl_right_side_blocks_help'] = 'By default the activity_modules, news_items, calendar_month and calendar_upcoming will appear on the right side. Add additional blocks for new courses coming in exactly like this: block_name_one,block_name_two .';
$string['uofl_course_year_help'] = 'Enter the current year so older or future semesters don\'t get imported.';
$string['uofl_course_term_help'] = 'Enter the term for the year. 1 - January (Spring), 2 - May (Summer), 3 - September (Fall)';
...
$string['log_enrollment_errors'] = 'Log Enrollment Data';
...
$string['savexmllocation'] = 'Save to';
...
$string['log_enrollment_errorshelp'] = 'If this box is checked, then all enrollment logs will be recorded to the logfile.';
...
$string['savexmllocationhelp'] = 'The path (on the Moodle server) where you would like to save the xml file.';
...
$string['page_uploadfile'] = 'Upload XML File';
$string['tools'] = 'Tools';
