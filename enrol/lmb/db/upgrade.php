...
function xmldb_enrol_lmb_upgrade($oldversion=0) {
    ...
    if ($oldversion < 2015091701) {
        // For any student that does not have a username or email yet, store them here.

        $table = new xmldb_table('enrol_lmb_dead_enrolments');
        $table->add_field('id', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, XMLDB_SEQUENCE, null);
        $table->add_field('idnumber', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
        $table->add_field('fullname', XMLDB_TYPE_TEXT, 'medium', null, null, null, null);
        $table->add_field('studentid', XMLDB_TYPE_CHAR, '12', XMLDB_UNSIGNED, null, null, null);
        $table->add_field('courseid', XMLDB_TYPE_CHAR, '32', XMLDB_UNSIGNED, null, null, null);
        $table->add_field('coursename', XMLDB_TYPE_TEXT, 'medium', null, null, null, null);
        $table->add_field('last_modified', XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, null, null, null);
