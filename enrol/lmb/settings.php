...
if ($ADMIN->fulltree) {
    ...
    // UofL Settings --------------------------------------------------------------------------------.
    $settingslmb->add(new admin_setting_heading('enrol_lmb_uofl_settings', get_string('uofl_title', 'enrol_lmb'), ''));

    // left column left block
    $settingslmb->add(new admin_setting_configtext('enrol_lmb/uofl_left_inst', get_string('uofl_default_blocks_left', 'enrol_lmb'),
            get_string('uofl_left_side_blocks_help', 'enrol_lmb'), ''));

    // left column right block
    $settingslmb->add(new admin_setting_configtext('enrol_lmb/uofl_right_inst', get_string('uofl_default_blocks_right', 'enrol_lmb'),
            get_string('uofl_right_side_blocks_help', 'enrol_lmb'), ''));

    
    // year start 
    $settingslmb->add(new admin_setting_configtext('enrol_lmb/uofl_course_year', get_string('uofl_course_year', 'enrol_lmb'),
            get_string('uofl_course_year_help', 'enrol_lmb'), ''));
    
    // month start 
    $settingslmb->add(new admin_setting_configtext('enrol_lmb/uofl_course_term', get_string('uofl_course_term', 'enrol_lmb'),
            get_string('uofl_course_term_help', 'enrol_lmb'), ''));

   // Merge the users who access Moodle before they finish their bridge setup? 
    $settingslmb->add(new admin_setting_configtext(
        'local_lmb_user_force_merge',
        get_string('local_lmb_user_force_merge_title', 'enrol_lmb'),
        'Merge on (1) or off (0)',
        1,
        PARAM_INT
    ));
    ...
    $settingslmb->add(new admin_setting_configtext(
        'local_lmb_debugging',
        get_string('local_lmb_debugging_title', 'enrol_lmb'),
    ...
    // XML Debugging 
    $settingslmb->add(new admin_setting_configtext(
        'local_lmb_debugging_xml',
        get_string('local_lmb_debugging_xml_title', 'enrol_lmb'),
        'Debugging on (1) or off (0)',
        0,
        PARAM_INT
    ));
   
    // XML Debugging for a specific user, look for sourcedid's
    $settingslmb->add(new admin_setting_configtextarea(
        'local_lmb_debugging_xml_custom_sourcedid',
        get_string('local_lmb_debugging_xml_custom_sourcedid_title', 'enrol_lmb'),
        'comma list of sourcedid\'s to watch',
        ''
    ));

    // XML Debugging for a specific user, look for usernames
    $settingslmb->add(new admin_setting_configtextarea(
        'local_lmb_debugging_xml_custom',
        get_string('local_lmb_debugging_xml_custom_title', 'enrol_lmb'),
        'comma list of usernames to watch',
        ''
    ));
    ...
    $settingslmb->add(new admin_setting_configcheckbox('enrol_lmb/log_enrollment_errors', get_string('log_enrollment_errors', 'enrol_lmb'),
            get_string('log_enrollment_errorshelp', 'enrol_lmb'), 1));
...
$settings->add("enroltoolsscat", new admin_externalpage('deadenrollments', get_string('dead_enrollments', 'enrol_lmb'),
        "$CFG->wwwroot/enrol/lmb/tools/deadview.php", "moodle/role:manage"));

$settings->add("enroltoolsscat", new admin_externalpage('uploadfile', get_string('page_uploadfile', 'enrol_lmb'),
        "$CFG->wwwroot/enrol/lmb/uploadfile.php", "moodle/role:manage"));
