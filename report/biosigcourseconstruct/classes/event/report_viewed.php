...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'report_');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the BioSig Course Construct report.";
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array(SITEID, "admin", "report ", "report//index.php?qtype=$requestedqtype", $requestedqtype);
    }
    ...
    public function get_url() {
        return new \moodle_url('/report//index.php', array('qtype' => $this->other['requestedqtype']));
    }
