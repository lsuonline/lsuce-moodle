...
error_log("\n\n====================================================\n");
error_log("What is the sql1: ". $sizesql);
error_log("What is the contextcheck: ". $contextcheck);
error_log("\nWhat is the cxsizes: ". print_r($cxsizes, true));
error_log("\n====================================================\n\n");
...
error_log("\n\n============  SHARED RESOURCES  =================================\n");
error_log("What is the sql2: ". $sizesql);
error_log("What is the contextcheck: ". $contextcheck);
error_log("\nWhat is the size: ". print_r($size, true));
error_log("\n====================================================\n\n");
